...
Wat er verandert ten opzichte van v3, op grond van run 3 in docs/eval-runs.md:

**Een besluit is iets anders dan een constatering.** v3 leverde elf besluiten
waar de evaluatieset er zeven kent. Geen daarvan was verzonnen, maar
vaststellingen over hoe iets nu is werden als besluit vastgelegd. Zie de nieuwe
sectie hieronder.

De rest van v3 blijft staan: triage naast de lijst, `owner_raw` altijd gevuld,
een toegewezen verantwoordelijkheid als besluit én toezegging, en letterlijke
citaten.
...
dicht is. Er zit een moment in waarop iets anders wordt dan het was.
